    ...
    <>
      <div className="max-w-screen-2xl container mx-auto md:py-20 py-6 md:px-20 px-4 flex flex-col flex-col-reverse md:gap-6 md:flex-row">
        <div className="w-full md:w-1/2 mt-6 md:mt-32 space-y-6">
          <div className="md:space-y-12 space-y-4">
            ...
            <p className="text-xl font-semibold">
              ...
              nesciunt ipsam nulla nostrum nisi laborum veritatis, perferendis
              voluptas expedita maxime quod corrupti possimus ipsa atque vel
              quia minima? Distinctio, ipsam
            </p>
          </div>
        ...
        <div className="w-full md:w-1/2 flex">
          <img
            srcSet={bannerPng}
            className="w-80 h-80 md:w-full md:h-full md:pt-16 pt-6 mx-auto align-items-center"
          />
        </div>
      </div>
    </>
