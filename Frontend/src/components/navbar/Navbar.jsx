...
const Navbar = () => {
    ...
    return (
        <>
            <div className= {`z-50   fixed top-0 left-0 right-0 ${sticky ? "static-nav bg-base-200 dark:text-slate-50 dark:bg-slate-950 text-slate-800 bg-slate-200 shadow-md duration-300 transition-all ease-in-out":""} `} >
                <div className="navbar max-w-screen-2xl container font-extrabold mx-auto md:px-20 px-4">
                    <div className="navbar-start">
                        ...
                        <Link to="/" className="font-bold  text-2xl">BookStore</Link>
                    </div>
