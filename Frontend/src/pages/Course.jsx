    ...
    <div className="pt-16 max-w-screen-2xl container mx-auto py-10">
      <div className="text-center capitalize max-w-4xl mx-auto  md:space-y-8">
        ...
        <p className="">
          ...
          dignissimos earum tenetur perspiciatis omnis accusantium? Quia
          quibusdam quasi cumque dolorem porro delectus error minus quisquam,
          perspiciatis cum consectetur maxime dolortis.
        </p>
        <Link to="/">
      ...
      <div className=" grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 justify-center">
        {booksData.map((itam) => (
          <BookCard key={itam.id} book={itam} />
        ))}
      </div>
    </div>
  );
